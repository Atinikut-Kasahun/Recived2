    ...
    const navGroups = [
        ...
        }] : []),
        {
            ...
            items: [
                ...
                ...(isAdmin || user?.roles?.some((r: any) => r.slug === 'managing_director' || r.slug === 'hr_manager') ? [{ label: 'Hiring Plan', href: '/admin/dashboard?tab=HiringPlan', icon: <ClipboardList size={16} /> }] : []),
            ]
        },
        {
            group: 'Organization',
