...
<body>
    <div class="wrapper">
        ...
        <div class="content">
            <p class="intro">Dear <strong>{{ $applicant->name }}</strong>,</p>
            <p class="intro">Thank you for your interest in the <span class="highlight">{{ $job->title }}</span>
                position at <span class="company-name">{{ $tenant->name }}</span>.</p>
            <p class="intro">We've reviewed your application and would like to invite you to an interview to learn more
                about your experience and fit for our team.</p>
            <p class="intro">Our hiring manager will be in touch shortly to coordinate a convenient time for the
                meeting.</p>
            <p class="intro">We look forward to speaking with you!</p>
            <div class="signature">
                <p style="margin: 0;">Best regards,<br><span class="company-name">{{ $tenant->name }} – TA Team</span>
                </p>
            </div>
        </div>
        <div class="footer">
